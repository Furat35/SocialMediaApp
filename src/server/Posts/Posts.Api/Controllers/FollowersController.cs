...
using Posts.Api.Core.Application.Features.Followers.RemoveBan;
using Posts.Api.Core.Application.Features.Followers.SendFollowRequest;
...
namespace Posts.Api.Controllers
{
    ...
    public class FollowersController(IMediator mediator) : BaseController
    {
        ...
        [HttpPost("ban/{userId}")]
        public async Task<IActionResult> BanFollower([FromRoute] BanFollowerCommand request)
        {
            var response = await mediator.Send(request);
            return CreateActionResult(response);
        }
        ...
        public async Task<IActionResult> RemoveBan([FromRoute] RemoveBanCommand request)
        {
            var response = await mediator.Send(request);
            return CreateActionResult(response);
        }
